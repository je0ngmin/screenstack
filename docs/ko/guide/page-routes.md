...
Hero의 도착점은 대상 요소의 현재 화면 geometry를 계속 따라갑니다. Route의 translate, scale,
rotation이 반영되며 전환 중 매 프레임 도착점을 다시 측정합니다. 대상 Hero가 mount된 뒤
위치나 크기가 변경되더라도 과거 좌표를 향하지 않고 새로운 위치에 맞춰 자동으로 이동합니다.
